...
const translations: Record<'en' | 'es', Record<string, string>> = {
  en: {
    ...
    'services.trial.description': 'Try a 30-minute class to assess your level and discuss your learning goals.',
    ...
    'services.standard.feature1': '60-minute sessions',
  ...
  es: {
    ...
    'services.trial.description': 'Prueba una clase de 30 minutos para evaluar tu nivel y discutir tus objetivos de aprendizaje.',
    'services.trial.price': '€10.50',
    ...
    'services.standard.price': '€21.00',
    'services.standard.feature1': 'Sesiones de 60 minutos',
